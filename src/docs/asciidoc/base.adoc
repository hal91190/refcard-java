...
//TODO à compléter
NOTE: https://docs.oracle.com/javase/tutorial/java/nutsandbolts/operators.html[Operators],
...
https://docs.oracle.com/javase/specs/jls/se14/html/jls-15.html[Expressions],
https://docs.oracle.com/javase/specs/jls/se14/html/jls-14.html[Blocks and Statements]
