...
.Exemple : définir l'_ordre naturel_ des objets (interface https://docs.oracle.com/en/java/javase/15/docs/api/java.base/java/lang/Comparable.html[`Comparable`])
[source,java,indent=0]
----
/**
...
+
TIP: la référence étant alors du type de l'interface, seules les méthodes de l'interface sont accessibles
+
...
NOTE: Plus d'information dans le tutoriel https://docs.oracle.com/javase/tutorial/java/javaOO/enum.html[The Java Tutorials - Enum Types] ou dans la section {jlsurl}/jls-8.html#jls-8.9[8.9. Enum Types] de la spécification du langage.
