...
.Exemple : la classe `Rectangle2D`
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2D.java[tag=rect]
----

.Exemple : la classe `Rectangle2DPlein`
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2DPlein.java[tag=rect-plein-1,rect-plein-tostring]
----

.Exemple : utilisation du polymorphisme
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2DPlein.java[tag=rect-plein-use-2]
----

.Exemple : la description dans Rectangle2D (Java)
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2D.java[tag=rect-tostring]
----

.Exemple : la description dans Rectangle2DPlein (Java)
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2DPlein.java[tag=rect-plein-tostring]
----
...
.Exemple : redéfinition de la méthode `toString()` de `Rectangle2D`
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2D.java[tag=rect-tostring]
----

.Exemple : redéfinition de la méthode `toString()` de `Rectangle2DPlein`
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2DPlein.java[tag=rect-plein-tostring]
----
...
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2DPlein.java[tag=rect-plein-use-3]
----
...
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2D.java[rect-equals]
----

.Exemple : contraintes de `equals`
[source,java,indent=0]
----
include::{java-sourcedir}/inheritance/Rectangle2DPlein.java[tag=rect-plein-use-4]
----
